...
@Component({
  selector: 'app-leave-and-od-analysis',
  templateUrl: './leave-and-od-analysis.component.html',
  styleUrls: ['./leave-and-od-analysis.component.css']
})
export class LeaveAndOdAnalysisComponent {
