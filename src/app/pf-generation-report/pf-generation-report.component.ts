...
@Component({
  selector: 'app-pf-generation-report',
  templateUrl: './pf-generation-report.component.html',
  styleUrls: ['./pf-generation-report.component.css']
})
export class PfGenerationReportComponent {
payId: any
  EmpLists: any[] = [];
  payslips: any[] = []
  employee: any;
